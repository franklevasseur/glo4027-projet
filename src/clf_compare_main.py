...
if __name__ == "__main__":
    ...
    clfs = [RandomForestRegressor, LinearSVR, MLPRegressor, LinearRegression]
    clf_results = []
    n = 10
    for clf in clfs:
        kaggle_scores = []
        for i in range(n):
            ...
            kaggle_score, _ = train_and_predict(clf(), clf(),
                                                     Xcasual,
                                                     Ycasual,
                                                     Xregistered,
                                                     Yregistered,
        ...
        clf_results.append([clf.__name__, mean_kaggle_score, std_kaggle_score])

    print(tabulate(clf_results, ("Modèle", "moyenne sur {} essais".format(n), "écart-type sur {} essais".format(n)), tablefmt='latex'))
